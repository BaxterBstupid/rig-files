...
echo "=== Fusion nodes SKIPPED (lean mode - full-rate camera) ==="
#LEAN: python3 ~/overlay_check_node.py > "$LOGDIR/overlay.log" 2>&1 &


#LEAN: python3 ~/colorized_fusion_node.py > "$LOGDIR/colorized.log" 2>&1 &
